...
class FechaHora:
    ...
    #agregamos metodos para la ejecucion del ejercicio 7
    
    def __add__ (self, unaHora):
        if ((type(self)== FechaHora) and (type(unaHora) == Hora)):
            return FechaHora(self.__dia, self.__mes, self.__anio, self.__hs + unaHora.getHora(), self.__min + unaHora.getMin(), self.__seg + unaHora.getSeg())
        elif (type(unaHora) == int):
            return FechaHora (self.__dia + unaHora, self.__mes, self.__anio, self.__hs, self.__min, self.__seg)

    def __radd__ (self, unaHora):
        if ((type(self)== FechaHora) and (type(unaHora) == Hora)):
            return FechaHora(self.__dia, self.__mes, self.__anio, self.__hs + unaHora.getHora(), self.__min + unaHora.getMin(), self.__seg + unaHora.getSeg())
        elif (type(unaHora) == int):
            return FechaHora (self.__dia + unaHora, self.__mes, self.__anio, self.__hs, self.__min, self.__seg)

    def __sub__ (self, unaHora):
        if ((type(self)== FechaHora) and (type(unaHora) == Hora)):
            return FechaHora (self.__dia, self.__mes, self.__anio, self.__hs - unaHora.getHora(), self.__min - unaHora.getMin(), self.__seg - unaHora.getSeg())
        elif (type(unaHora) == int): 
            return FechaHora (self.__dia - unaHora, self.__mes, self.__anio, self.__hs, self.__min, self.__seg)